...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "OOK LAB PREV", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OOK LAB PREV")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 10000000, 2, 0, 0)
